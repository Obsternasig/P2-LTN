...
require_once "connection.php";
	...
	if(isset($id)) {
		...
		echo "<p class='infoinfo'>" . ucfirst($kompassoc['category']) . "</p>";
		
		echo "<h3 class='infoover'> Mærke: " . "</h3>";
		echo "<p class='infoinfo'>" . ucfirst($kompassoc['brand']) . "</p>";
		
		echo "<h3 class='infoover'> Placering: " . "</h3>";
		echo "<p class='infoinfo'>" . ucfirst($kompassoc['location']) . "</p>";
		...
		echo "<p class='infoinfo'>" . ucfirst($kompassoc['comment']) . "</p>";
